...
- 문법은 공홈을 기준으로 길게 설명된것은 빼고 쓰는 방법만 정리해봄 
- text로 쓰는방법 블록 다음 실제 출력 블록순으로
...
- 문서 내 링크 
    ...
    - 공식적으로 되는건 아님
        ...
        -  Bla bla <sup id="a1">[1](#f1)</sup>
        - <b id="f1">1</b> Footnote content here. [↩](#a1)
    - 그러니까 gitlab나 github나 더 만들어놓은 문법이 따로 있는것같은데 gitlab는 footnote하는게 있는것같음 근데 github엔없음
